...
import { z } from "zod";
import {convertToModelMessages,createUIMessageStream,isStepCount,pipeUIMessageStreamToResponse,streamText,toUIMessageStream,tool,type UIMessage,} from "ai";
...
import {buildConversationTitle,getLastUserMessageText,getTextFromUIMessage,} from "../utils/chat-messages.js";
...
export async function streamWorkspaceChat(
    ...
    //! The most important part: Parallel retrieval -> Pinecone(workspace knowledge) + Mem0(user memories)
    ...
    //! This creates citation metadata that will eventually be stored alongside the assistant response.
    ...
    const stream = createUIMessageStream({
      ...
      onFinish: async ({ responseMessage, isAborted }) => {
        ...
        //! Har 8 Msgs kk badd ye Process hoga
