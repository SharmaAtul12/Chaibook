...
/** CHUNK_OVERLAP = 100 tells your chunker to repeat 100 characters from the previous chunk at the beginning of the next chunk, 
 * preserving context across chunk boundaries for better RAG retrieval. 
*/
