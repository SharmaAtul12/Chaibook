...
import { findSourceById } from "../repository/sources.repository.js";
...
export const processSource = inngest.createFunction(
  ...
  async ({ event, step }) => {
      ...
      try {
          ...
          throw error; // You're telling Inngest -> The workflow really failed. Don't consider this successful. Retry it 
      }
  },
);
