...
//* Creates the TypeScript type representing the Conversation data returned by Prisma using conversationSelect.
...
/**
 * touchConversation() marks a conversation as recently active by updating its updatedAt timestamp, while returning the 
 * conversation using the same conversationSelect shape.
 */
