...
export function WorkspaceChat({
    ...
    return (
        <div className="flex min-h-0 flex-1 flex-col">
            <div className="flex items-center gap-2 border-b bg-background/80 px-4 py-3 backdrop-blur supports-backdrop-filter:bg-background/60">
                <Select
                ...
                >
                    <SelectTrigger className="max-w-sm flex-1 rounded-full">
                        ...
                        <MessageScrollerContent className="mx-auto w-full max-w-3xl px-4 py-6">
                            {conversationsLoading || messagesLoading ? (
                                ...
                                <div className="flex flex-col items-center justify-center gap-4 py-20 text-center">
                                    <div className="relative flex size-16 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-primary">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <p className="max-w-sm text-sm text-muted-foreground">
                                            Ask questions about the materials in
                                            this workspace. Answers include
