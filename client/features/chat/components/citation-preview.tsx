...
export function CitationPreview({
    ...
    return (
        <div className="space-y-3">
            <div className="flex items-start gap-2.5">
                ...
                <div className="min-w-0 flex-1 space-y-1">
                    <div className="flex items-center gap-2">
                        {markerIndex != null ? (
                            <span className="inline-flex size-5 shrink-0 items-center justify-center rounded-full bg-primary/15 text-[10px] font-semibold text-primary ring-1 ring-inset ring-primary/20">
                                {markerIndex}
                            </span>
                        ) : null}
            ...
            <p className="line-clamp-5 rounded-xl bg-muted/50 p-2.5 text-xs leading-relaxed text-muted-foreground">
                {citation.excerpt}
            </p>
