                            ...
                            return (
                                <SidebarMenuItem key={source.id}>
                                    ...
                                    >
                                        ...
                                        {isActive ? (
                                            <span className="ml-auto flex size-1.5 shrink-0 animate-pulse rounded-full bg-sky-500" />
                                        ) : source.status === "FAILED" ? (
                                            <span className="ml-auto flex size-1.5 shrink-0 rounded-full bg-destructive" />
                                        ) : null}
                                    </SidebarMenuButton>
                                </SidebarMenuItem>
                            );
